        ...
        public static List<Gizmo> BuildGizmos(List<PingInfo> selected, LocationPings loc)
        {
            ...
            if (ownedMarkerCount > 0)
            {
                ...
                var desc = foreignMarkerCount > 0
                    ? "MpPingSel_DeleteForeignDesc".Translate(ownedMarkerCount, foreignMarkerCount).ToString()
                    : "MpPingSel_DeleteDesc".Translate().ToString();
                ...
                if (ownedMarkerCount == 1 && foreignMarkerCount == 0)
                {
                    ...
                    if (theOne != null)
                    {
                        result.Add(new Command_Action
                        {
                            ...
                            defaultDesc  = "MpPingSel_RenameDesc".Translate(),
            ...
            if (foreignSampleUsername != null)
            {
                ...
                result.Add(new Command_Action
                {
                    ...
                    defaultDesc  = "MpPingSel_MutePlayerDesc".Translate(foreignSampleUsername),
                ...
                if (foreignSampleFactionId >= 0)
                {
                    ...
                    result.Add(new Command_Action
                    {
                        ...
                        defaultDesc  = "MpPingSel_MuteFactionDesc".Translate(factionName),
                        icon         = MultiplayerStatic.PingMuteIcon,
            ...
            if (foreignSpectatorPresent)
            {
                ...
                result.Add(new Command_Action
                {
                    ...
                    defaultDesc  = "MpPingSel_MuteSpectatorsDesc".Translate(),
                    icon         = MultiplayerStatic.PingMuteIcon,
            ...
            if (markerIds.Count > 0)
            {
                ...
                result.Add(new Command_Action
                {
                    ...
                    defaultDesc  = "MpPingSel_TransparencyDesc".Translate(),
                ...
                result.Add(new Command_Action
                {
                    ...
                    defaultDesc  = "MpPingSel_HideLocallyDesc".Translate(),
                ...
                if (anyDimmed || anyHidden)
                {
                    result.Add(new Command_Action
                    {
                        ...
                        defaultDesc  = "MpPingSel_ResetLocalAppearanceDesc".Translate(),
            ...
            result.Add(new Command_Action
            {
                ...
                defaultDesc  = "MpPingSel_DeselectAllDesc".Translate(),
